...
namespace easytracker {
	...
	// --------------------------------------------------------------------------
	void AssignmentProblemSolver::assignmentoptimal(assignments_t& assignment, float& cost, const distMatrix_t& distMatrixIn, size_t nOfRows, size_t nOfColumns)
	{
	...
	//
	// --------------------------------------------------------------------------
	void AssignmentProblemSolver::computeassignmentcost(const assignments_t& assignment, float& cost, const distMatrix_t& distMatrixIn, size_t nOfRows)
	{
		for (size_t row = 0; row < nOfRows; row++)
		{
	...
	//
	// --------------------------------------------------------------------------
	void AssignmentProblemSolver::step3_5(assignments_t& assignment, float *distMatrix, bool *starMatrix, bool *newStarMatrix, bool *primeMatrix, bool *coveredColumns, bool *coveredRows, size_t nOfRows, size_t nOfColumns, size_t minDim)
	{
		for (;;)
		{
			/* step 3 */
	...
	// --------------------------------------------------------------------------
	void AssignmentProblemSolver::assignmentsuboptimal2(assignments_t& assignment, float& cost, const distMatrix_t& distMatrixIn, size_t nOfRows, size_t nOfColumns)
	{
	...
	// --------------------------------------------------------------------------
	void AssignmentProblemSolver::assignmentsuboptimal1(assignments_t& assignment, float& cost, const distMatrix_t& distMatrixIn, size_t nOfRows, size_t nOfColumns)
	{
		/* make working copy of distance Matrix */
		const size_t nOfElements = nOfRows * nOfColumns;
		float* distMatrix = (float *)malloc(nOfElements * sizeof(float));
